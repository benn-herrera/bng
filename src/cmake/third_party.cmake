...
function(add_3p_header_lib NAME REPO VERSION INTERFACE_DIR GLOB_TYPE)
  ...
  file(${GLOB_TYPE} H_HEADERS RELATIVE "${THIRD_PARTY_DIR}" "${INTERFACE_DIR}/*.h")
  file(${GLOB_TYPE} HPP_HEADERS RELATIVE "${THIRD_PARTY_DIR}" "${INTERFACE_DIR}/*.hpp")

  file(${GLOB_TYPE} C_SOURCES RELATIVE "${THIRD_PARTY_DIR}" "${INTERFACE_DIR}/*.c")
  file(${GLOB_TYPE} CPP_SOURCES RELATIVE "${THIRD_PARTY_DIR}" "${INTERFACE_DIR}/*.cpp")
